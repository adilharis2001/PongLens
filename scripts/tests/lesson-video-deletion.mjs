...
try {
 ...
 `);
 for (const name of ['173_lesson_video.sql','174_lesson_video_import_identity.sql','175_lesson_video_storage.sql','177_lesson_video_account_deletion.sql','20260906033000_lesson_video_production_hardening.sql'])
