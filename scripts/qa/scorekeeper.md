...
| Expected | 86 scenarios pass: desktop 1440×900 and mobile 393×660, forty-three each |
...
| Early-outcome checks only | `QA_SCENARIO=early node scripts/qa/scorekeeper.mjs` runs 46 checks: both winners, Skip, live taps, L/K shortcuts, Split/No, Undo, immediate and delayed failed saves, timing threshold, corrections, navigation, close/reopen, manual resume, full-card-off playback and natural handoff into a separate point clip |
| Early-outcome behavior | A first winner or Skip with more than 3.5 seconds remaining offers the existing Split/No choice while the remaining full card continues playing. Split pauses to open Modify; No advances. Tail completion, navigation, Undo, a correction or a failed save retires the old offer. The nudge adds no playback pause. Live winner taps retain their valid ending observation; Skip and paused answers do not create one. |
