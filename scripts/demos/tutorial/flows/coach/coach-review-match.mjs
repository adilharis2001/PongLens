...
export const scenes = [
  ...
  { beat: "analysis-maps", action: { type: "click", target: { aria: "Close player" } }, waitFor: { text: "Serve placement", tag: "h2" }, target: { text: "Match analysis", tag: "h2" }, secondaryTarget: { text: "Serve placement", tag: "h2" }, primaryLabel: "Match analysis", secondaryLabel: "Serve placement" },
