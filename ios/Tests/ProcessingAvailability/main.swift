...
@MainActor func run() async throws {
    ...
    check(phone.continuingLabel == "Cutting the video" && phone.exitMessage == "We’ll email you when your match is ready.", "a cut on the iPhone reads as any hand cut and keeps the ready email")
    check(phone.continuingLabel == MatchProcessingFeedback.deviceStageLabel(nil), "Home and the match page name a phone's cut alike")
