    ...
    private func shutter(recordingAllowed: Bool) -> some View {
        ...
        return Button {
            if recorder.state == .recording {
                ...
                // where this recording's upload begins. The New match door
                // asked for the AI features permission already; this is
                // the backstop for a camera reached some other way, or a
                // permission switched off since. Not now leaves the camera
                // as it was, not recording.
                Task {
