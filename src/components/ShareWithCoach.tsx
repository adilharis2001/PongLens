...
/**
 * "Share with coach" button + bottom sheet. Creates a pending coach_links
 * row (scoped to one match or all matches) and hands back an invite URL
 * to copy or share. Used on the match page and the dashboard; on the
 * dashboard there is no match in context so scope is locked to "all".
 */
