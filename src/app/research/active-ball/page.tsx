...
export default async function Page() {
  ...
  const {data:evaluations,error:evaluationError} = await db.from('active_ball_evaluations').select('run_id,sample_id,model,prediction,reference_label,reference_revision').in('run_id',['gemini-3.8-flash-20260905-v4','ponglens-yolo26n-20260905-v3']);
