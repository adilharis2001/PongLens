...
export default async function Page() {
  ...
  const {data:evaluations,error:evaluationError} = await db.from('active_ball_evaluations').select('sample_id,model,prediction,reference_label,reference_revision').eq('run_id','gemini-3.8-flash-20260905-v4');
