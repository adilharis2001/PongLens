...
test("the research catalog contains every current research page", () => {
  assert.deepEqual(
    ...
    [
      { title: "Point-ending labels", href: "/research/point-endings" },
      { title: "V3 serve detector", href: "/research/v3-serve-detector" },
      { title: "Body detector", href: "/research/body-detector" },
      { title: "End-on detector", href: "/research/endon-detector" },
      ...
      { title: "Crossing cards", href: "/research/crossings" },
      { title: "Serve misses", href: "/research/serve-misses" },
      { title: "Score gaps", href: "/research/scores" },
      { title: "Side-on cameras", href: "/research/sidecam" },
      { title: "Point recall", href: "/research/recall" },
      { title: "Serve accuracy", href: "/research/serve-accuracy" },
  ...
  assert.equal(new Set(RESEARCH_PAGES.map((page) => page.href)).size, 26);
