...
.v3 #showbar button { font:inherit; font-size:12.5px; cursor:pointer; padding:4px 12px;
  border-radius:999px; border:1px solid #2a323d; background:transparent; color:#c9d2dc; }
.v3 #showbar button[aria-pressed="true"] { background:#e7ecf3; color:#0b0d10; border-color:#e7ecf3; }
