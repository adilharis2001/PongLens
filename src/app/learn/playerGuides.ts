...
export const playerGuides: Guide[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Open How to record before your first match. Put the camera to the side of your half or diagonally behind your corner, around head height, with the full table and both players in view. Record sideways when you can.",
    ...
    sections: [
      {
        heading: "Quick steps",
        steps: [
          "Open Coaching, then Your coaches, and choose Add a coach to create an invite link.",
          ...
          "A coach you have only written down while filing a lesson is on that list too. Open them and choose Send an invite.",
          "Open a coach later to change what they can see, end their access, or remove them from your list.",
        ],
        images: [
