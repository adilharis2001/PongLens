    ...
    sections: [
      {
        ...
        steps: [
          ...
          "For a connected student, choose Share to send it into their Journal.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The invite panel on the student's page shows how many entries are ready for them. Use its share button to include all remaining entries in one step.",
        ],
      },
      {
