...
/**
 * One feature: a real screen on one side, a heading and a sentence or two
 * on the other. Sides alternate down the page so the eye moves. On a
 * phone the text comes first and the screen sits under it, whichever side
 * it takes on a laptop: a heading is what tells you what you are looking
 * at, so it cannot come after the picture.
 */
function Feature({
  id,
  title,
