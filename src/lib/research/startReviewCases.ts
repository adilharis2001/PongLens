import 'server-only';
import {START_REVIEW_RUN_ID,START_REVIEW_CORRECTION_RUN_ID,type StartReviewCase} from './startReview';
...
// Three owner-approved candidates remain unchanged. Two failed pair associations
// now retain their original padded starts under the frozen correction rules.
...
export const START_REVIEW_CASES:readonly StartReviewCase[]=Object.freeze([
 ...
 {pointId:'d8f5e064-90e5-4962-a1f2-0a2bb935fcfe',runId:START_REVIEW_CORRECTION_RUN_ID,retainedExistingStart:true,proposedStart:217.28,recordedServeTap:220.72000000000003},
 {pointId:'04608d39-326e-4846-87b6-f8187bfd9ed0',runId:START_REVIEW_CORRECTION_RUN_ID,retainedExistingStart:true,proposedStart:335.3,recordedServeTap:336.18},
