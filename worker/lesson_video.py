...
Every work_on line is one complete second-person sentence of plain written English, roughly 10 to 20 words, situation first where the coach tied it to one. The two lists must read differently, because they sit at either end of the same recap: goals name what was being worked on, follow-ups tell the student what to do. Never repeat a line within a list. Do not add advice from sports knowledge, and do not stretch a passing remark into a goal to reach a count."""
