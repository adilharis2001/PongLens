...
class Decision(unittest.TestCase):
    ...
    def test_never_when_the_table_reads_end_on(self):
        ...
        # The production crop floor was deliberately lowered from 0.40 to
        # 0.20 after the body-pipeline review. Use a genuinely degenerate
        # 0.18 quad here; the old 0.25 fixture is now intentionally allowed.
        endon = dict(VISION, table_corners_px={
            "A_near_1": [868.2, 741.3], "B_near_2": [1260.3, 699.9],
            "C_far_2": [1020.0, 610.0], "D_far_1": [980.0, 612.0]})
