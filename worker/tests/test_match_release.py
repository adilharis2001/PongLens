...
class ReleaseTests(unittest.TestCase):
    ...
    def test_manifest_seals_canonical_database_contract(self):
        manifest = verify(self.built())
        self.assertEqual(manifest['database'], {
            'minimum_migration': '20260916120000',
            'canonical_publication_contract': 1,
        })
    ...
    def test_child_paths_resolve_once_and_caches_are_outside(self):
        ...
        self.assertEqual(env['PONGLENS_MINIMUM_DB_MIGRATION'], '20260916120000')
        self.assertEqual(env['PONGLENS_CANONICAL_PUBLICATION_CONTRACT'], '1')
