...
-- raw unit, not per vendor display unit. The initial interval begins
-- 2026-01-01 so aggregate 2026 backfill events are priceable; source labels
-- preserve the date each rate was verified.
insert into public.cost_rates (
  ...
  ('Cloudflare', 'R2', 'r2-standard', 'class_a_operation',
   0.0000045, 1000000, '2026-01-01T00:00:00Z',
   'https://developers.cloudflare.com/r2/pricing/',
   'Cloudflare R2 Standard pricing, 2026-07-29'),
  ('Cloudflare', 'R2', 'r2-standard', 'class_b_operation',
   0.00000036, 10000000, '2026-01-01T00:00:00Z',
   'https://developers.cloudflare.com/r2/pricing/',
   'Cloudflare R2 Standard pricing, 2026-07-29'),
  ...
  ('Synthetic', 'Compute', 'cloud-worker-medium-high', 'compute_second',
   0.000416666666666667, 0, '2026-01-01T00:00:00Z',
   'https://ponglens.app',
